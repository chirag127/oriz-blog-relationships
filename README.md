# Relationships — `oriz-blog-relationships`

> The human wiring — communication, boundaries, and connection that lasts.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-relationships?style=flat)](https://github.com/chirag127/oriz-blog-relationships/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-relationships)](https://github.com/chirag127/oriz-blog-relationships/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-relationships/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-relationships/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Relationships** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A relationships blog on communication, boundaries, and connection — practical, non-preachy notes on the human side of life.

- **Live site:** https://relationships-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-relationships
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-relationships/ — the canonical, always-current site is **https://relationships-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-relationships/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>relationships-blog.oriz.in"]
...
```
oriz-blog-relationships/
├── src/
│   ├── content/blog/       # the relationship essays (MDX/Markdown)
