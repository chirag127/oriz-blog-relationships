...
export const SITE_CONFIG: BlogConfig = {
  title: 'Between — a relationships letter',
  description:
    'Practical, warm writing on communication, long distance, and boundaries — for people building real relationships.',
  url: 'https://relationships-blog.oriz.in',
  defaultLocale: 'en',
  author: {
    name: 'Chirag Singhal',
  ...
  giscus: {
    repo: env('PUBLIC_GISCUS_REPO', 'chirag127/oriz-blog-relationships') as `${string}/${string}`,
